...
class ProductAdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) { 
    final provider=Provider.of<ProductProvider>(context,listen: true);
     final provider2=Provider.of<DataProvider>(context,listen: true);
